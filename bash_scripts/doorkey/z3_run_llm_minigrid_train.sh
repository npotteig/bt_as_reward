...
uv run bt_as_reward/training/minigrid_train.py \
    ...
    --drop_key $dropkey \
    --object_function_file "llm_functions/doorkey/z3_doorkey_code.py" \
    --object_function_names "subtask_1_object, subtask_2_object, subtask_3_object" \
    --subtask_function_file "llm_functions/doorkey/z3_doorkey_code.py" \
    --subtask_names "Pick up the yellow key, Unlock the yellow door, Reach the green goal" \
