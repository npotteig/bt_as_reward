...
if __name__ == "__main__":
    ...
    if args.uncertainty == "true":
        tensorboard_dict = {
            "bt_as_reward_mask_uncertainty": {"label": "Original MRBT", "color": "red", "files": []},
            "bt_as_reward_mask_uncertainty_dependent": {"label": "Modified MRBT", "color": "#008B8B", "files": []},
        }
    else:
        tensorboard_dict = {
            "bt_as_reward_mask": {"label": "Original MRBT", "color": "red", "files": []},
            "bt_as_reward_mask_dependent": {"label": "Modified MRBT", "color": "#008B8B", "files": []},
        }
    ...
    for key, data in tensorboard_dict.items():
        ...
        plt.plot(steps, smoothed_mean, label=data["label"], color=data.get("color", None))
        plt.fill_between(
            steps,
